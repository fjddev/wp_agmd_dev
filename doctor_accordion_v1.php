...
<div id="accordion"  role="tablist">
      <div class="card" id="<?php echo '#state_top_' . strtolower($stateAbbr) . '_top';  ?>">
        <div class="card-header" role="tab" id="heading">
          <h2 class="mb-0"><a   href="<?php echo '#' .  strtolower($_state_name); ?>"  class="btn agmd-btn-primary btn-block stated toggle" 
     		        state_abbr="<?php echo $stateAbbr?>" data-parent="#accordion" data-toggle="collapse" aria-expanded="false" aria-controls="<?php echo strtolower($_state_name);?>" role="button">
