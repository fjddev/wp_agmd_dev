...
<div id="accordion"  role="tablist">
      <div class="card" id="<?php echo '#state_top_' . strtolower($stateAbbr) . '_top';  ?>">
        <div class="card-header" role="tab" id="heading">
          <h2 class="mb-0"><a   href="<?php echo '#' .  strtolower($_state_name); ?>"  class="card-link btn agmd-btn-primary btn-block stated toggle" 
     		        state_abbr="<?php echo $stateAbbr?>"  data-toggle="collapse">
            <h4 ><?php echo $stateName; ?></h4>
          </a></h2>
        </div>

        <div id="<?php echo strtolower($_state_name);?>" class="collapse" data-parent="#accordion">
