...
(function($){
	...
	theme = {
			...
			if (api.options.thumb_links){
        		...
        		$(vars.thumb_forward).click(function(){
        			if (vars.thumb_page - vars.thumb_interval <= -$(vars.thumb_list).width()){
        				vars.thumb_page = 0;
        				$(vars.thumb_list).stop().animate({'left': vars.thumb_page}, {duration:500, easing:'easeOutMyriad'});
        			}else{
				...
				$(vars.thumb_tray).mousemove(function(e) {
					...
					if (listWidth > containerWidth){
						...
						if (diff > 10 || diff < -10) { 
						    ...
						    $(vars.thumb_list).stop().animate({'left':newX}, {duration:diff*3, easing:'easeOutMyriad'});
						}
					}
				});
			}
	 ...
	 $.supersized.themeVars = {
		...
		image_path			:	'Library/sliders/supersized-slideshow/img/',				// Default image path
