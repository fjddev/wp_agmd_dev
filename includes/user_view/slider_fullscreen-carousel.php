<?php
function i3d_show_fullscreen_carousel($sliderID) {
   ...
   // print "a";
	...
	//  $portfolioImages = get_option('luckymarble_nonflash_image_portfolio');
	   ...
	   wp_register_style( 'i3d-fullscreen-carousel',  get_template_directory_uri() .'/Library/sliders/fullscreen-carousel/css/fullscreen-carousel.css');
...
if(is_array($portfolioImages)) {
		...
		?>
<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="<?php echo $slideTime; ?>">
...
if (I3D_Framework::$bootstrapVersion >= 3) { ?>
 <?php if (I3D_Framework::$fullscreenCarouselVersion == 2) { ?>
	jQuery("#myCarousel").parents(".container-wrapper").addClass("fullscreen-carousel-wrapper").removeClass("container-wrapper");
	jQuery("#myCarousel").parents(".fullscreen-carousel-wrapper").find(".container").addClass("fullscreen-carousel").removeClass("container");
 <?php } else { ?> 
	jQuery("#myCarousel").parents(".container-wrapper").addClass("fullscreen-carousel").removeClass("container-wrapper");
	 
 <?php } ?>

<?php } else { ?>

jQuery("#myCarousel").parents(".container-fluid").addClass("fullscreen-carousel").removeClass("container-fluid");
jQuery("#myCarousel").parents(".container").removeClass("container");
<?php } ?>
</script>
