...
/**        SIDEBAR REGION         **/
/***********************************/
class I3D_Widget_HeaderPreset extends WP_Widget {
	function __construct() {
	//function I3D_Widget_HeaderPreset() {
		$widget_ops = array('classname' => 'i3d_header_preset', 'description' => __( 'This renders a preset group, for the header of the page.', "i3d-framework") );
		parent::__construct('i3d_headerpreset', __('i3d:Header Preset', "i3d-framework"), $widget_ops);
	}
	...
	function widget( $args, $instance ) {		
		...
		//$page_level_sidebar = get_post_meta($page_id, 'i3d-right-sidebar-'.$instance['page-level-config'], true);
