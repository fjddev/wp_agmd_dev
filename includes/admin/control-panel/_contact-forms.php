...
var stylesheetDirectory = "<?php echo get_stylesheet_directory_uri() ; ?>";
	...
	function changeFieldType(selectBox,id) {
		...
		if (selectedValue != "") {
		  ...
		  if (selectedValue != "separator" && selectedValue != "label" && selectedValue != "heading" && selectedValue != "checkbox") {
...
?>
         ...
         <table class='table table-striped'>
           <tr>
             <th style='width: 145px;'>Object <i class='fa fa-info-circle tt' title='This is the type of input field, or display object (Heading, Label, Separator) that you want to display.'></i></th>
             <th style='width: 145px;' class='field_details_container field_details__<?php echo $counter; ?>__all'>Name/Label <i class='fa fa-info-circle tt' title='Even if you are not showing the label, you must define the Name/Label in order for the contents of the field to be emailed to you.'></i></th>
             <th class='field_details_container field_details__<?php echo $counter; ?>__show_label' style='width: 70px; <?php if ($field['fieldtype'] == "separator" || $field['fieldtype'] == "heading" || $field['fieldtype'] == "label"  || $field['fieldtype'] == "radio" || $field['fieldtype'] == "checkbox") {?> display: none;<?php } ?>'>Visible <i class='fa fa-info-circle tt' title='You may choose not to display the field label.'></i></th>
             <th class='field_details_container field_details__<?php echo $counter; ?>__show_icon' style='width: 105px;<?php if ($field['fieldtype'] == "separator" || $field['fieldtype'] == "heading" || $field['fieldtype'] == "label"  || $field['fieldtype'] == "radio" || $field['fieldtype'] == "checkbox") {?> display: none;<?php } ?>'>Icon <i class='fa fa-info-circle tt' title='You may specify an icon that prepends the input field.'></i></th>
             <th class='field_details_container field_details__<?php echo $counter; ?>__required' style='width: 80px; <?php if ($field['fieldtype'] == "separator" || $field['fieldtype'] == "captcha2" || $field['fieldtype'] == "heading" || $field['fieldtype'] == "label" || $field['fieldtype'] == "checkbox") {?>display: none;<?php } ?>'>Required <i class='fa fa-circle-sign tt' title='You may choose to make your input field required.'></i></th>
             <th class='field_details_container field_details__<?php echo $counter; ?>__input_width' <?php if ($field['fieldtype'] == "separator" || $field['fieldtype'] == "heading" || $field['fieldtype'] == "label" || $field['fieldtype'] == "radio" || $field['fieldtype'] == "checkbox") { ?> style="display: none;"<?php } ?>>Width <i class='fa fa-info-circle tt' title='This is the width of the input field (for text, select boxes, and textareas)'></i></th>
             ...
             <th class='field_details_container field_details__<?php echo $counter; ?>__date' <?php if ($field['fieldtype'] != "date") {?>style="display: none;"<?php } ?>>Format <i class='fa fa-info-circle tt' title='Specify the date format you wish to collect.'></i></th>
                          <th class='field_details_container field_details__<?php echo $counter; ?>__captcha2' <?php if ($field['fieldtype'] != "captcha2") {?>style="display: none;"<?php } ?>>Site Key <i class='fa fa-info-circle tt' title='Specify your Site Key.  Click the [G] icon to go to Google to get your Site and Secret Key.'></i> <a href='https://www.google.com/recaptcha/admin' target="_blank"><i class='fa fa-google'></i></a></th>
                                                    <th class='field_details_container field_details__<?php echo $counter; ?>__captcha2' <?php if ($field['fieldtype'] != "captcha2") {?>style="display: none;"<?php } ?>>Secret Key <i class='fa fa-info-circle tt' title='Specify your Secret Key.  Click the [G] icon to go to Google to get your Site and Secret Key.'></i> <a href='https://www.google.com/recaptcha/admin' target="_blank"><i class='fa fa-google'></i></th>
           ...
           <tr>
             ...
             <td class='field_details_container field_details__<?php echo $counter; ?>__all'><input  onkeyup='renderPreview(<?php echo $counter; ?>);'  onchange='renderPreview(<?php echo $counter; ?>);'  style='width: 140px;' type="text" id="<?php echo $counter; ?>__label" name="<?php echo $counter; ?>__label" value="<?php echo $field['label']; ?>" /></td>
             <td class='field_details_container field_details__<?php echo $counter; ?>__show_label' <?php if ($field['fieldtype'] == "separator" || $field['fieldtype'] == "heading" || $field['fieldtype'] == "label"  || $field['fieldtype'] == "radio" || $field['fieldtype'] == "checkbox") {?> style="display: none;"<?php } ?>><select onchange='renderPreview(<?php echo $counter; ?>);'  style='width: 60px;' class="design" id="<?php echo $counter; ?>__show_field_label" name="<?php echo $counter; ?>__show_field_label"><option value="0">No</option><option <?php if ($field['show_field_label'] == "1" || $field['show_field_label'] == "" ) { echo "selected"; } ?> value="1">Yes</option></select></td>
             <td class='field_details_container field_details__<?php echo $counter; ?>__show_icon' <?php if ($field['fieldtype'] == "separator" || $field['fieldtype'] == "heading" || $field['fieldtype'] == "label"  || $field['fieldtype'] == "radio" || $field['fieldtype'] == "checkbox") {?> style="display: none;"<?php } ?>><?php I3D_Framework::renderFontAwesomeSelect("{$counter}__prepend_icon", $field['prepend_icon'], false, '-- None --', '-- None --', 'renderPreview('.$counter.')'); ?>
             <td class='field_details_container field_details__<?php echo $counter; ?>__required' <?php if ($field['fieldtype'] == "separator" || $field['fieldtype'] == "heading" || $field['fieldtype'] == "captcha2" ||  $field['fieldtype'] == "label"  || $field['fieldtype'] == "checkbox") {?>style="display: none;"<?php } ?>><select style='width: 60px;'  class="design" id="<?php echo $counter; ?>__required" name="<?php echo $counter; ?>__required"><option value="0">No</option><option <?php if ($field['required'] == "1" ) { echo "selected"; } ?> value="1">Yes</option></select></td>
             <td class='field_details_container field_details__<?php echo $counter; ?>__input_width' <?php if ($field['fieldtype'] == "separator" || $field['fieldtype'] == "heading" || $field['fieldtype'] == "label" || $field['fieldtype'] == "radio" || $field['fieldtype'] == "checkbox") { ?> style="display: none;"<?php } ?>><select onchange='renderPreview(<?php echo $counter; ?>);' style='width: 60px;' class="design" id="<?php echo $counter; ?>__input_class" name="<?php echo $counter; ?>__input_class">
                   <?php if (I3D_Framework::$bootstrapVersion < 3) { ?>
                    <option value="">100%</option>
