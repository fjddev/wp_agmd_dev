...
global $post, $columnSelectedId, $lmTemplates, $lmColumns, $defaultTemplate, $lmNivoVersion, $templateName;
  ...
  $sitemapData = get_post_meta($post->ID, "sitemap", true);
...
?>
<div class='special-region non-visible sitemap' id="tabs-sitemap-overview">
<div class='page-layout-editor-summary row-fluid'>
	<!--<div class='span2'><img src="<?php echo get_template_directory_uri(); ?>/images/layouts/sitemap.jpg" /></div>-->
        <div class='col-sm-12'>
            <h2>Selected Layout: Sitemap</h2>
            <p> The "Sitemap Layout" layout is designed to be be used to help your visitors "find their way".</p>
           <!-- <h5>Your "Sitemap Layout" Checklist</h5>
