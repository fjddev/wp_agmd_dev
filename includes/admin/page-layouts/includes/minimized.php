...
?>
<div class='special-region non-visible default' id="tabs-minimized-overview"> 
...
<!--	<div class='span2'><img src="<?php echo get_template_directory_uri(); ?>/images/layouts/minimized.jpg" /></div>-->
        <div class='col-sm-12'>
            <h2>Selected Layout: Minimized</h2>
            <p class='lead'>The "Minimized" layout is designed to be the general purpose layout for your size, and is often considered the "default" layout.</p>
