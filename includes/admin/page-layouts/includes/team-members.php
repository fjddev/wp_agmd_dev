...
?>
<div class='special-region non-visible team-members' id="tabs-team-members-overview">
<div class='page-layout-editor-summary row-fluid'>
	<!--<div class='span2'><img src="<?php echo get_template_directory_uri(); ?>/images/layouts/team-members.jpg" /></div>-->
        <div class='col-sm-12'>
            <h2>Selected Layout: Team Members</h2>
            <p>The "Team Members" layout is designed to be showcase the members of your 'team' or 'staff'.</p>
          <!--  <h5>Your "Team Members" Layout Checklist</h5>
