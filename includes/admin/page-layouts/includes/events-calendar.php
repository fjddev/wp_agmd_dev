...
?>
<div class='special-region non-visible events-calendar' id="tabs-events-calendar-overview"> 
<div class='page-layout-editor-summary row-fluid'>
<!--	<div class='span2'><img src="<?php echo get_template_directory_uri(); ?>/images/layouts/minimized.jpg" /></div>-->
        <div class='col-sm-12'>
            <h2>Selected Layout: Events Calendar</h2>
            <p class='lead'>The "Events Calendar" layout is designed to be used with the "Tribe" Events Calendar Plugin.</p>
            <!--<h5>Your "Minimized" Checklist</h5>
