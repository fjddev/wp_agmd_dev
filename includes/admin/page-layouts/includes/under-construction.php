...
?>
<div class='special-region non-visible under-construction' id="tabs-under-construction-overview">
<div class='page-layout-editor-summary row-fluid'>
	<!--<div class='span2'><img src="<?php echo get_template_directory_uri(); ?>/images/layouts/under-construction.jpg" /></div>-->
        <div class='col-sm-12'>
            <h2>Selected Layout: Under Construction</h2>
            <p>The "Under Construction Page" layout is designed to be your website's landing page while you are building your website, so that the public doesn't see an incomplete site.</p>
            <!--<h5>Your "Under Construction Page" Checklist</h5>
